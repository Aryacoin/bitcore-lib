...
A PublicKey in Ayacore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
```javascript
> var ayacore = require('ayacore');

// compressed public key starting with 0x03 (greater than midpoint of curve)
> var compressedPK = ayacore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new ayacore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = ayacore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
