...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/ayacore/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/ayacore/tree/master/lib/errors/spec.js).
