...
```sh
bower install bitcore-lib-aryacoin
...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/bitcore-lib-aryacoin.min.js"></script>
...
```sh
browserify --require ./index.js:bitcore-lib-aryacoin | uglifyjs > bitcore-lib-aryacoin.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external bitcore-lib-aryacoin | uglifyjs > bitcore-mnemonic.min.js
```
