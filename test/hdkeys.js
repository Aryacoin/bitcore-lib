...
var HDPublicKey = ayacore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ayacore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ayacore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(ayacore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ayacore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ayacore.PublicKey.fromPoint;
      ayacore.PublicKey.fromPoint = function() {
        ayacore.PublicKey.fromPoint = unstubbed;
